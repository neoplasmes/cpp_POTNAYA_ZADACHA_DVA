...
### __Отменяем__ все следующие шаги, если вершин в Massivе получилось 2. Если 3, то вычисляем площадь, испоьзуя анонимный объект класса Треугольник, вызывая его функцию вычисления площади.
